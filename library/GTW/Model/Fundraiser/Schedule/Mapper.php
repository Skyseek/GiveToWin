...
/**
 * Fundraiser Schedule Mapper
 *
 * @package    Givetowin
 * @copyright  Copyright (c) 2011, Give to Win, Inc
 * @author     Sean Thayne <sean@skyseek.com
 */
class GTW_Model_Fundraiser_Schedule_Mapper extends Skyseek_Model_Mapper 
{

	protected $_tableName = 'fundraiser_schedule';
	protected static $_instance;
	protected static $_identityMap = array();

	/**
	 * @return GTW_Model_Fundraiser_Schedule_Mapper
	 */
	...
	/**
	 * @return GTW_Model_Fundraiser_Schedule_Collection
	 */
	public function getCollection(Skyseek_Model_Entity_Collection_Request $request) 
	{
		...
		$collection = new GTW_Model_Fundraiser_Schedule_Collection();
	...
	public function getPaginator(Skyseek_Model_Entity_Collection_Request $request = null) 
	{
		...
		$paginator->setFilter(new GTW_Model_Fundraiser_Schedule_Collection());
	...
	/**
	 * @return GTW_Model_Fundraiser_Schedule
	 */
	private function createScheduleEntity($data, $lazyLoad=true) 
	{

		$entity = new GTW_Model_Fundraiser_Schedule($data);


		if (!$lazyLoad) {
			$entity->getStatus();
			$entity->getFundraiser();
			$entity->getCity();
		}
	...
	/**
	 *
	 * @param GTW_Model_Fundraiser_Schedule $schedule
	 * 
	 * @return GTW_Model_Fundraiser_Schedule
	 */
	public function save(GTW_Model_Fundraiser_Schedule $fundraiserSchedule) 
	{
		$data = array(
			'city_id'		=> $schedule->city->id,
			'status_id'		=> $schedule->status->id,
			'fundraiser'	=> $schedule->fundraiser->id,
