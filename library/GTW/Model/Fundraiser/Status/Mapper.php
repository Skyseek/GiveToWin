...
/**
 * Fundraiser Status Mapper
 *
 * @package    Givetowin
 * @copyright  Copyright (c) 2011, Give to Win, Inc
 * @author     Sean Thayne <sean@skyseek.com
 */
class GTW_Model_Fundraiser_Status_Mapper extends Skyseek_Model_Mapper 
{

	protected $_tableName = 'fundraiser_status';
	...
	/**
	 * @return GTW_Model_Fundraiser_Status_Collection
	 */
	public function getCollection(Skyseek_Model_Entity_Collection_Request $request = null) 
	{
		...
		$collection = new GTW_Model_Fundraiser_Status_Collection();
	...
	public function getPaginator(Skyseek_Model_Entity_Collection_Request $request) 
	{
		...
		$paginator->setFilter(new GTW_Model_Fundraiser_Status_Collection());
	...
	private function createFundraiserStatusEntity($data, $lazyLoad) 
	{
		...
		$entity = new GTW_Model_Fundraiser_Status(array(
			'id'			=> $data['id'],
			'status'		=> $data['status'],
