...
class GTW_Model_Offer_Form extends Zend_Form 
{
	...
	public function getOffer() 
	{
		...
		$this->_offer->fine_print	= $this->_finePrintElement->getValue();
		$this->_offer->highlights	= $this->_highlightsElement->getValue();
	...
	private function _initForm() 
	{
		...
		$this->addSubForm($this->_profileTabPage4, 'profileTabPage4');
	...
	private function _initProfilePage3Tab() 
	{
		...
		$form = new Zend_Form_SubForm();
		$form->addElements(array(
			$this->_highlightsElement
		));

		$form->setDecorators(array(
			'FormElements',
			array('HtmlTag',array('tag'=>'div', 'id'=>'tab-highlights', 'class'=>'tabs-content'))
		));

		$this->_profileTabPage3 = $form;
	}

	private function _initProfilePage4Tab() 
	{

		$form = new Zend_Form_SubForm();
		$form->addElements(array(
			$this->_finePrintElement
		));

		$form->setDecorators(array(
			'FormElements',
			array('HtmlTag',array('tag'=>'div', 'id'=>'tab-fine-print', 'class'=>'tabs-content'))
		));

		$this->_profileTabPage4 = $form;
	}
	...
	private $_finePrintElement;
	private $_highlightsElement;
	...
	private function _initElements() 
	{
		...
		$this->_initHighlightsElement();
		$this->_initFinePrintElement();
	}
	...
	private function _initFinePrintElement() 
	{
		$element = $this->createElement('textarea', 'fine_print')
			->setLabel("Fine Print")
			->setAttrib('class', 'full-width')
			->setRequired();

		$this->_finePrintElement = $element;
	}

	private function _initHighlightsElement() 
	{
		$element = $this->createElement('textarea', 'highlights')
			->setLabel("Highlights")
			->setAttrib('class', 'full-width')
			->setRequired();

		$this->_highlightsElement = $element;
	}
