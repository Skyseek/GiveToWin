 ...
 */
class GTW_Model_Offer_Status_Mapper extends Skyseek_Model_Mapper 
{

	protected $_tableName = 'offer_status';
	...
	/**
	 * @return GTW_Model_Offer_Status_Collection
	 */
	public function getCollection(Skyseek_Model_Entity_Collection_Request $request = null) 
	{
		...
		$collection = new GTW_Model_Offer_Status_Collection();
	...
	public function getPaginator(Skyseek_Model_Entity_Collection_Request $request) 
	{
		...
		$paginator->setFilter(new GTW_Model_Offer_Status_Collection());
	...
	private function createOfferStatusEntity($data, $lazyLoad) 
	{
		...
		$entity = new GTW_Model_Offer_Status(array(
			'id'			=> $data['id'],
			'status'		=> $data['status'],
