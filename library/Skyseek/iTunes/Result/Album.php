 ...
 */
class Skyseek_iTunes_Result_Album extends Skyseek_iTunes_Result {
	...
	public function  __construct(stdClass $data) {
		...
		foreach($data as $property=>$value) {
			if(property_exists($this, $property)) {
				...
				switch($property) {
					...
					case 'collectionViewUrl':
						...
						break;
					case 'artistViewUrl':
						$this->iTunesArtistUrl = $value;
						break;
					case 'collectionExplicitness':
						$this->isExplicit = ($value == 'explicit');
						break;
					default:
						//echo $property . " / ";
			...
			if($data->artworkUrl100) {
					$data->artworkUrl30 = str_replace ('100x100', '30x30', $data->artworkUrl100);
