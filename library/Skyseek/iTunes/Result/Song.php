 ...
 */
class Skyseek_iTunes_Result_Song extends Skyseek_iTunes_Result {
	...
	public $albumId;
	public $albumName;
	public $albumCensoredName;
	public $albumIsExplicit;
	public $albumPrice;
	public $length;
	public $price;
	public $iTunesUrl;
	public $iTunesArtistUrl;
	public $iTunesAlbumUrl;
