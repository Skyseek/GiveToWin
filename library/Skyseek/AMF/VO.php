 ...
 */
class Skyseek_AMF_VO extends Skyseek_VO {
	/**
	 * Is Success Boolean
	 *
	 * @var boolean
	...
	/**
	 * ErrorVO to respond with (if any)
	 *
	 * @var Skyseek_ErrorVO
	 **/
	public $error;

	public function __construct($success=true, $response=null, Skyseek_Error_VO $errorVO=null) {
