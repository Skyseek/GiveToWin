 ...
 */
class Skyseek_Exception extends Exception {
	/**
	 * Returns a Skyseek_Error_VO
	 *
	 * @return Skyseek_Error_VO
	 */
	public function getErrorVO() {
		$vo = new Skyseek_Error_VO();
		$vo->code = $this->getCode();
		$vo->message = $this->getMessage();
