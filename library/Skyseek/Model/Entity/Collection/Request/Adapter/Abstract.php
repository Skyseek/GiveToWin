 ...
 */
abstract class Skyseek_Model_Entity_Collection_Request_Adapter_Abstract {
    protected $_request;

	public function __construct(Skyseek_Model_Entity_Collection_Request $request) {
	...
	/**
	 *
	 * @return Skyseek_Model_Entity_Collection_Request
	 */
