...
INSERT INTO `city` VALUES (1,13,2,'Athens'),(2,13,2,'Atlanta'),(3,13,2,'Columbus'),(4,13,2,'Savannah'),(5,13,1,'Sandy Springs'),(6,13,1,'Macon');
...
CREATE TABLE `city_subscription` (
  ...
  CONSTRAINT `fk_city_subscription_city1` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION
...
INSERT INTO `city_subscription` VALUES (3,1,2);
...
CREATE TABLE `coupon` (
  ...
  CONSTRAINT `fk_coupon_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
...
CREATE TABLE `donation` (
  ...
  CONSTRAINT `fk_donation_user1` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION,
...
CREATE TABLE `fundraiser` (
  ...
  CONSTRAINT `fk_fundraiser_charity1` FOREIGN KEY (`charity_id`) REFERENCES `charity` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_fundraiser_fundraiser_status1` FOREIGN KEY (`status_id`) REFERENCES `fundraiser_status` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fundraiser_schedule` (
  ...
  CONSTRAINT `fk_fundraiser_schedule_fundraiser1` FOREIGN KEY (`fundraiser_id`) REFERENCES `fundraiser` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_fundraiser_schedule_city1` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_fundraiser_schedule_fundraiser_status1` FOREIGN KEY (`status_id`) REFERENCES `fundraiser_schedule_status` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
...
CREATE TABLE `offer_schedule` (
  ...
  CONSTRAINT `fk_offer_schedule_offer1` FOREIGN KEY (`offer_id`) REFERENCES `offer` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_offer_schedule_city1` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  CONSTRAINT `fk_offer_schedule_offer_schedule_status1` FOREIGN KEY (`status_id`) REFERENCES `offer_schedule_status` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `fk_user_city1` FOREIGN KEY (`city_id`) REFERENCES `city` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2011-09-26 16:00:03
